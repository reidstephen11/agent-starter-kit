...
**Please do not include, in an issue, a pull request or a discussion:**

- Any student work, student name, or anything from which a student could be identified.
- Your school's name, if that is not something you have decided to attach to this.
- Anything from a class list, enrolment file or student management system.

Redact before you paste. An anonymised example makes the same point.

Contributions are accepted under the same licence as the repo (CC BY 4.0).
