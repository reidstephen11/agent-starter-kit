...
Your blank starting documents — unit plan, lesson outline, assessment task, rubric,
student journal or logbook. The agent starts from these rather than inventing a structure
each time.

Two that matter more than the rest:

- **The unit plan template** — it encodes what you consider mandatory. If a section exists
...
- **The student working document** (journal/logbook/portfolio) — if you plan to run the
  ...
  that quietly mangles someone's work in week 6.
